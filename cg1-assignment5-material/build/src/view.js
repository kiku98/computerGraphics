...
class NDC extends gl_1.GLRenderer {
     ...
     * @param name
     */
    async visualize(model, camera, name) {
        ...
        const texture = await load(`./assets/${name}.png`);
        ...
        this.scene.add(new three_1.LineSegments(new three_1.WireframeGeometry(g), new three_1.LineBasicMaterial({ color: 0xaaaaaa })), new three_1.Mesh(g, new three_1.MeshBasicMaterial({
            map: texture,
