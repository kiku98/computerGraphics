...
class Mat4 {
    ...
    inv() {
        ...
        n.set(0, 0, (this.get(1, 2) * this.get(2, 3) * this.get(3, 1) -
            ...
            d);
        n.set(0, 1, (this.get(0, 3) * this.get(2, 2) * this.get(3, 1) -
            ...
            d);
        n.set(0, 2, (this.get(0, 2) * this.get(1, 3) * this.get(3, 1) -
            ...
            d);
        n.set(0, 3, (this.get(0, 3) * this.get(1, 2) * this.get(2, 1) -
            ...
            d);
        n.set(1, 0, (this.get(1, 3) * this.get(2, 2) * this.get(3, 0) -
            ...
            d);
        n.set(1, 1, (this.get(0, 2) * this.get(2, 3) * this.get(3, 0) -
            ...
            d);
        n.set(1, 2, (this.get(0, 3) * this.get(1, 2) * this.get(3, 0) -
            ...
            d);
        n.set(1, 3, (this.get(0, 2) * this.get(1, 3) * this.get(2, 0) -
            ...
            d);
        n.set(2, 0, (this.get(1, 1) * this.get(2, 3) * this.get(3, 0) -
            ...
            d);
        n.set(2, 1, (this.get(0, 3) * this.get(2, 1) * this.get(3, 0) -
            ...
            d);
        n.set(2, 2, (this.get(0, 1) * this.get(1, 3) * this.get(3, 0) -
            ...
            d);
        n.set(2, 3, (this.get(0, 3) * this.get(1, 1) * this.get(2, 0) -
            ...
            d);
        n.set(3, 0, (this.get(1, 2) * this.get(2, 1) * this.get(3, 0) -
            ...
            d);
        n.set(3, 1, (this.get(0, 1) * this.get(2, 2) * this.get(3, 0) -
            ...
            d);
        n.set(3, 2, (this.get(0, 2) * this.get(1, 1) * this.get(3, 0) -
            ...
            d);
        n.set(3, 3, (this.get(0, 1) * this.get(1, 2) * this.get(2, 0) -
